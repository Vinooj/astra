...
# ==============================================================================
# 2. DEFINE A2A PROTOCOL MODELS (for FastAPI)
# ==============================================================================
...
# ==============================================================================
# 3. SET UP THE MOCK LLM AND TOOLS (Copied from run_workflow.py)
# ==============================================================================
...
# ==============================================================================
# 4. INITIALIZE THE ASTRA FRAMEWORK AND WEB SERVER
# ==============================================================================
...
adder_agent = LLMAgent(
    ...
    llm_client=mock_llm,
    tools=[add],
    instruction="You are an adder agent. Add the first two numbers."
)
...
multiplier_agent = LLMAgent(
    ...
    llm_client=mock_llm,
    tools=[multiply],
    instruction="You are a multiplier agent. Multiply the last tool result by the final number."
)
...
# ==============================================================================
# 5. DEFINE THE A2A SERVER ENDPOINTS
# ==============================================================================
